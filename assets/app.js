...
let worker, workerReady = false, selectedIdx = null, currentScores = null, selectedDetail = null, currentRankingRows = [], lastCityStudy = null;
...
const EN_TEXT={
"urbes · afinidad climática territorial":"cities · territorial climate affinity","Comparar urbes o países":"Compare cities or countries","Idioma":"Language","Ecuador":"Equator","Meridianos y paralelos":"Meridians and parallels","afinidad alta":"high affinity","afinidad media":"medium affinity","afinidad baja":"low affinity","Arrastra o mantén rueda: mover · rueda: zoom":"Drag or hold the wheel: pan · wheel: zoom","Click: seleccionar · click derecho: deseleccionar":"Click: select · right-click: clear selection","Explorador climático territorial":"Territorial climate explorer","Elige una urbe en el mapa":"Choose a city on the map","Compara temperatura, agua, luz, humedad, nubes y viento a lo largo del año. Úsalo para descubrir referencias; no sustituye un estudio local, sísmico o cultural.":"Compare temperature, water, light, humidity, clouds and wind across the year. Use it to discover references; it does not replace a local, seismic or cultural study.","Iniciando motor…":"Starting engine…","Urbe seleccionada":"Selected city","Deseleccionar":"Clear selection","Temperatura media":"Average temperature","Rango semanal":"Weekly range","Precipitación":"Precipitation","Humedad":"Humidity","Sol":"Sunshine","Nubosidad":"Cloud cover","Modelo":"Model","Afinidad climática":"Climate affinity","Uso general":"General use","Arquitectura bioclimática":"Bioclimatic architecture","Balanceado":"Balanced","Térmico / confort pasivo":"Thermal / passive comfort","Agua / riego y preservación":"Water / irrigation and conservation","Luz / energía solar":"Light / solar energy","Estacionalidad":"Seasonality","Misma estación local (verano con verano)":"Same local season (summer with summer)","Adaptar hemisferio (permite desplazar seis meses)":"Adapt hemisphere (allows a six-month shift)","Mismo calendario (enero con enero)":"Same calendar (January with January)","Estaciones a comparar":"Seasons to compare","Verano":"Summer","Otoño":"Autumn","Invierno":"Winter","Primavera":"Spring","Puedes marcar una o varias estaciones. Con las cuatro activas, la comparación usa el año completo.":"Select one or more seasons. With all four active, the comparison uses the full year.","Ajustar pesos":"Adjust weights","Escala continua del heatmap":"Continuous heatmap scale","Intermedio":"Midpoint","Máximo":"Maximum","Recalcular heatmap":"Recalculate heatmap","Exportar mapa PNG 2160p":"Export 2160p PNG map","Referencias":"References","Top 10 afinidades":"Top 10 affinities","Excluir misma celda climática":"Exclude same climate cell","Excluir mismo país":"Exclude same country","Excluir misma región":"Exclude same region","Excluir mismo continente":"Exclude same continent","Ocultar en el mapa todo salvo el conjunto elegido":"Hide everything on the map except the selected set","Área donde buscar afinidades":"Area to search for affinities","Todo el mundo":"Worldwide","Continente elegido":"Selected continent","Subcontinente elegido":"Selected subcontinent","País elegido":"Selected country","Destino de comparación":"Comparison destination","Conjunto visible":"Visible set","Top X ciudades":"Top X cities","Top X% más parecido":"Top X% most similar","Afinidad igual o superior a X%":"Affinity equal to or above X%","Número de ciudades":"Number of cities","Mapas de país para dashboard":"Country maps for dashboard","País de destino":"Destination country","Exportar país · Top 10":"Export country · Top 10","Primer país":"First country","Segundo país":"Second country","Comparar países y exportar pares":"Compare countries and export pairs","Abrir estudio comparativo":"Open comparative study","Lectura comparativa":"Comparative reading","Estudio climático en profundidad":"In-depth climate study","Cerrar estudio comparativo":"Close comparative study","Tipo de estudio":"Study type","Dos urbes":"Two cities","Dos países":"Two countries","Urbe A":"City A","Urbe B":"City B","Comparar urbes":"Compare cities","País A":"Country A","País B":"Country B","Estaciones para cruzar pares":"Seasons for pair matching","Pares a mostrar":"Pairs to show","Top 10 (rápido)":"Top 10 (fast)","Encontrar 10 pares distintos":"Find 10 distinct pairs","Ver":"View","año completo":"full year","misma estación local":"same local season","estaciones locales equivalentes":"equivalent local seasons","hemisferio opuesto":"opposite hemisphere","mismo calendario":"same calendar","Motor listo":"Engine ready","Preparando fingerprint…":"Preparing fingerprint…","Mapa listo":"Map ready","Cargando coordenadas…":"Loading coordinates…","Cargando ciudad…":"Loading city…","Calculando similitud…":"Calculating similarity…","Calculando ranking…":"Calculating ranking…","Selección eliminada":"Selection cleared","Comparación de urbes lista":"City comparison ready","Estudio de países listo":"Country study ready","Comparando perfiles estacionales…":"Comparing seasonal profiles…","Buscando pares climáticos entre países…":"Searching climate pairs between countries…","No se pudo iniciar":"Could not start","Población no disponible":"Population unavailable","Rango térmico no disponible":"Thermal range unavailable","sin dato comparable.":"no comparable data.","valores prácticamente iguales.":"values are virtually identical.","temperatura estacional no disponible.":"seasonal temperature unavailable.","temperaturas estacionales son muy similares":"seasonal temperatures are very similar","Contraste principal:":"Main contrast:","Sin segundo contraste comparable.":"No comparable secondary contrast.","Radiografía estacional":"Seasonal profile","Lectura por estación":"Seasonal reading","Afinidad anual por dominio":"Annual affinity by domain","Resumen de afinidad por estación":"Seasonal affinity summary","Contexto anual y promedios":"Annual context and averages","Valores anuales y diferencia":"Annual values and difference","Variable":"Variable","Lectura anual":"Annual reading","Amplitud térmica anual":"Annual thermal range","afinidad con los parámetros actuales":"affinity with current settings","Período comparado:":"Period compared:","Cruce exhaustivo de los pares disponibles.":"Exhaustive matching across available pairs.","ver estudio estacional":"view seasonal study","ciudades incluidas":"cities included","Arrastra - rueda: zoom - doble clic: inicio":"Drag - wheel: zoom - double-click: reset"
};
const EN_ATTR={"Buscar una urbe (puedes añadir país)…":"Search for a city (you can add a country)…","Buscar una urbe y país":"Search for a city and country","Busca una segunda urbe":"Search for a second city","Busca o elige en el mapa":"Search or choose on the map","Mapa mundial interactivo":"Interactive world map","Capas geográficas":"Geographic layers","Leyenda del heatmap":"Heatmap legend","Idioma":"Language"};
Object.assign(EN_TEXT,{"Temperatura y sensación térmica":"Temperature and thermal sensation","Lluvia y estacionalidad hídrica":"Rainfall and water seasonality","Energía solar y horas de sol":"Solar energy and sunshine hours","Luz diurna disponible":"Available daylight","Viento":"Wind","clima en análisis":"climate under review","inviernos fríos y veranos muy cálidos":"cold winters and very warm summers","inviernos fríos y veranos templados":"cold winters and mild summers","veranos muy cálidos y una marcada amplitud térmica":"very warm summers and a marked thermal range","temperaturas templadas a cálidas":"mild to warm temperatures","temperaturas moderadas":"moderate temperatures","lluvias abundantes gran parte del año":"abundant rainfall for much of the year","lluvias escasas y un ambiente seco":"low rainfall and a dry environment","humedad alta durante buena parte del año":"high humidity for much of the year","vientos persistentes que definen su ambiente":"persistent winds that define its environment","un balance hídrico moderado":"a moderate water balance","con pocas horas de sol directo":"with limited direct sunshine","con cielos frecuentemente nubosos":"with frequently cloudy skies","Elige dos urbes para ver una radiografía por estación: temperatura, oscilación térmica y afinidad de cada dominio. Los promedios anuales quedan como contexto.":"Choose two cities to see a seasonal profile: temperature, thermal variation and each domain's affinity. Annual averages remain as context.","Los mapas muestran los primeros 10 pares. Selecciona un par de la lista para abrir automáticamente su comparación estacional entre urbes.":"Maps show the first 10 pairs. Select a pair to automatically open its seasonal city comparison.","Con «misma estación local», verano se compara con verano e invierno con invierno. El modo adaptativo conserva la alternativa de buscar la mejor alineación térmica.":"With ‘same local season’, summer is compared with summer and winter with winter. Adaptive mode keeps the alternative of finding the best thermal alignment."});
Object.assign(EN_TEXT,{"Uso general: temperatura, lluvia y humedad dominan; los demás factores conservan influencia.":"General use: temperature, rainfall and humidity dominate; other factors retain influence.","Arquitectura bioclimática: prioriza confort térmico y humedad; mantiene sol, lluvia y viento para orientar envolvente, sombreado, ventilación y drenaje.":"Bioclimatic architecture: prioritizes thermal comfort and humidity; retains sun, rain and wind to guide enclosure, shading, ventilation and drainage.","Cada dominio climático tiene el mismo peso.":"Each climate domain has equal weight.","Enfatiza el confort térmico y la moderación pasiva.":"Emphasizes thermal comfort and passive moderation.","Enfatiza agua, humedad y estacionalidad hídrica.":"Emphasizes water, humidity and water seasonality.","Enfatiza radiación solar y luz diurna.":"Emphasizes solar radiation and daylight.","Genera una imagen de 3840 × 2160 con mapa encuadrado, heatmap, ciudad de referencia y afinidades destacadas, sin paneles ni controles.":"Generates a 3840 × 2160 image with framed map, heatmap, reference city and highlighted affinities, without panels or controls.","Los factores visibles explican cada resultado. Son puntos de partida para investigar técnicas, no recomendaciones de construcción.":"Visible factors explain each result. They are starting points for researching techniques, not construction recommendations.","La lista usa el área elegida; las exclusiones se aplican tanto al ranking como al mapa.":"The list uses the selected area; exclusions apply to both ranking and map.","Exporta un país con las 10 ciudades más análogas a la urbe elegida; las etiquetas usan líneas cuando los nombres se solapan.":"Export a country with the 10 cities most analogous to the selected city; labels use leader lines when names overlap.","Compara pares de ciudades entre dos países usando los pesos y la estacionalidad actuales.":"Compare city pairs between two countries using the current weights and seasonality.","Temperatura y sensación térmica":"Temperature and thermal sensation","Lluvia y estacionalidad hídrica":"Rainfall and water seasonality","Energía solar y horas de sol":"Solar energy and sunshine hours","Luz diurna disponible":"Available daylight"});
let language="es",translating=false;const originalText=new WeakMap(),originalAttrs=new WeakMap();
function englishText(value){const lead=value.match(/^\s*/)?.[0]||"",tail=value.match(/\s*$/)?.[0]||"",core=value.trim();let text=EN_TEXT[core]||core;if(text===core){const replacements=[["Fingerprint listo","Fingerprint ready"],["inviernos fríos y veranos muy cálidos","cold winters and very warm summers"],["inviernos fríos y veranos templados","cold winters and mild summers"],["veranos muy cálidos y una marcada amplitud térmica","very warm summers and a marked thermal range"],["temperaturas templadas a cálidas","mild to warm temperatures"],["temperaturas moderadas","moderate temperatures"],["lluvias abundantes gran parte del año","abundant rainfall for much of the year"],["lluvias escasas y un ambiente seco","low rainfall and a dry environment"],["humedad alta durante buena parte del año","high humidity for much of the year"],["vientos persistentes que definen su ambiente","persistent winds that define its environment"],["un balance hídrico moderado","a moderate water balance"],["con pocas horas de sol directo","with limited direct sunshine"],["con cielos frecuentemente nubosos","with frequently cloudy skies"],["mismo calendario","same calendar"],["Temperatura y sensación térmica","Temperature and thermal sensation"],["Lluvia y estacionalidad hídrica","Rainfall and water seasonality"],["Energía solar y horas de sol","Solar energy and sunshine hours"],["Luz diurna disponible","Available daylight"],["Nubosidad","Cloud cover"],["Humedad","Humidity"],["Viento","Wind"],["Afinidad","Affinity"],["afinidad","affinity"],["climática","climate"],["ciudades","cities"],["ciudad","city"],["urbes","cities"],["urbe","city"],["países","countries"],["país","country"],["estacional","seasonal"],["estaciones","seasons"],["estación","season"],["comparación","comparison"],["comparar","compare"],["más cálida","warmer"],["más lluviosa","rainier"],["más húmeda","more humid"],["más ventosa","windier"],["más nubosa","cloudier"],["horas de sol","sunshine hours"],["temperatura","temperature"],["humedad","humidity"],["precipitación","precipitation"],["lluvia","rain"],["año","year"],["incluidas","included"],["mostrar","show"],["seleccionar","select"],["elegir","choose"],["No se pudo","Could not"],["Cargando","Loading"],["Calculando","Calculating"],["Estudio","Study"],["locales equivalentes","equivalent local seasons"],["año completo","full year"],["de afinidad","affinity"],["por estación","by season"],["por dominio","by domain"],["y diferencia","and difference"],["con mayor","with higher"],["con más","with more"],["sin dato","no data"],["no disponible","unavailable"]];for(const [from,to] of replacements)text=text.replaceAll(from,to);}return lead+text.replaceAll("mm/año","mm/year").replaceAll("h/d","h/day").replaceAll(" hab."," inhabitants")+tail;}
const ui=value=>language==="en"?englishText(String(value)):String(value);
function localizeNode(node){if(node.nodeType===Node.TEXT_NODE){if(!originalText.has(node))originalText.set(node,node.nodeValue);node.nodeValue=language==="en"?englishText(originalText.get(node)):originalText.get(node);return;}if(node.nodeType!==Node.ELEMENT_NODE||node.closest("[data-i18n-ignore]"))return;for(const attr of ["placeholder","title","aria-label"]){if(!node.hasAttribute(attr))continue;let saved=originalAttrs.get(node);if(!saved){saved={};originalAttrs.set(node,saved);}if(!(attr in saved))saved[attr]=node.getAttribute(attr);node.setAttribute(attr,language==="en"?(EN_ATTR[saved[attr]]||englishText(saved[attr])):saved[attr]);}}
function applyLanguage(root=document.body){if(translating)return;translating=true;document.documentElement.lang=language;document.title=language==="en"?"Neo Climate Twin — territorial climate affinities":"Neo Climate Twin — afinidades climáticas territoriales";const walker=document.createTreeWalker(root,NodeFilter.SHOW_TEXT|NodeFilter.SHOW_ELEMENT);let node=walker.currentNode;while(node){localizeNode(node);node=walker.nextNode();}translating=false;}
function initLanguage(){const saved=localStorage.getItem("neo-climate-language"),browser=[...(navigator.languages||[]),navigator.language||""].some(code=>String(code).toLowerCase().startsWith("es"));language=saved|| (browser?"es":"en");const select=$("language-select");select.value=language;select.addEventListener("change",()=>{language=select.value;localStorage.setItem("neo-climate-language",language);applyLanguage();if(cfg){applyPreset($("preset").value);updateVisibilityValue();if(selectedDetail)renderDetail(selectedDetail);if(selectedIdx!=null)refreshResults();if(lastCityStudy)renderCityStudy(lastCityStudy);}});new MutationObserver(records=>{if(translating)return;for(const record of records)record.addedNodes.forEach(node=>applyLanguage(node));}).observe(document.body,{childList:true,subtree:true,characterData:true});applyLanguage();}
...
class RasterMap {
  ...
  projectIdx(idx){const x=this.mx(this.positions[idx*2]),y=this.my(this.positions[idx*2+1]);let dx=x-this.center.x,dy=y-this.center.y;if(dx>.5)dx-=1;if(dx<-.5)dx+=1;if(dy>.5)dy-=1;if(dy<-.5)dy+=1;return{x:this.w/2+dx*this.world(),y:this.h/2+dy*this.world()}}
  pick(sx,sy,radius){
    const a=this.screenToNorm(sx-radius,sy-radius),b=this.screenToNorm(sx+radius,sy+radius),wrap=value=>((value%1)+1)%1;const lonA=this.lon(a.x),lonB=this.lon(b.x),latA=this.lat(wrap(a.y)),latB=this.lat(wrap(b.y));const deg=this.spatial.bin_deg,nx=this.spatial.nx,ny=this.spatial.ny;const y0=clamp(Math.floor((Math.min(latA,latB)+90)/deg),0,ny-1),y1=clamp(Math.floor((Math.max(latA,latB)+90)/deg),0,ny-1);const centerLon=this.lon(wrap(this.screenToNorm(sx,sy).x));const lonSpan=Math.max(1,Math.abs(lonB-lonA));const cx=Math.floor((centerLon+180)/deg);const bins=Math.ceil(lonSpan/deg)+1;let best=-1,bestD=radius*radius;
  ...
  flyTo(idx){const tx=this.mx(this.positions[idx*2]),ty=this.my(this.positions[idx*2+1]),tz=Math.max(this.zoom,5);const sx=this.center.x,sy=this.center.y,sz=this.zoom;let dx=tx-sx,dy=ty-sy;if(dx>.5)dx-=1;if(dx<-.5)dx+=1;if(dy>.5)dy-=1;if(dy<-.5)dy+=1;const t0=performance.now(),dur=520;const step=now=>{const t=clamp((now-t0)/dur,0,1),e=1-Math.pow(1-t,3);this.center.x=sx+dx*e;this.center.y=sy+dy*e;this.zoom=sz+(tz-sz)*e;this.normalizeCenter();this.schedule();if(t<1)requestAnimationFrame(step)};requestAnimationFrame(step);}
}
let mapView;
...
function areaLabel(){const scope=$("top-scope").value;if(scope==="global")return language==="en"?"the world":"todo el mundo";return $("top-area").selectedOptions[0]?.textContent||ui("el área elegida")}
...
function setupControls(){
  ...
  $("preset").value="balanced";applyPreset("balanced");updateHeatScale();$("preset").addEventListener("change",e=>applyPreset(e.target.value));$("apply").addEventListener("click",()=>selectedIdx!=null&&recompute());$("export-2160").addEventListener("click",export2160p);$("clear").addEventListener("click",clearSelection);
...
function climateSnapshot(c){
  const min=Number(c.min_week_temp_c),max=Number(c.max_week_temp_c),rain=Number(c.annual_precip_mm_est),humidity=Number(c.avg_humidity_pct),sun=Number(c.avg_sunshine_hours),cloud=Number(c.avg_cloud_pct),wind=Number(c.avg_wind_kmh);
  const thermal=!Number.isFinite(min)||!Number.isFinite(max)?"clima en análisis":min<=5&&max>=29?"inviernos fríos y veranos muy cálidos":min<=7?"inviernos fríos y veranos templados":max>=30?"veranos muy cálidos y una marcada amplitud térmica":max>=25?"temperaturas templadas a cálidas":"temperaturas moderadas";
  const moisture=Number.isFinite(rain)&&rain>=1400?"lluvias abundantes gran parte del año":Number.isFinite(rain)&&rain<=350?"lluvias escasas y un ambiente seco":Number.isFinite(humidity)&&humidity>=78?"humedad alta durante buena parte del año":Number.isFinite(wind)&&wind>=18?"vientos persistentes que definen su ambiente":"un balance hídrico moderado";
  const light=Number.isFinite(sun)&&sun<4.5?"con pocas horas de sol directo":Number.isFinite(cloud)&&cloud>=72?"con cielos frecuentemente nubosos":"";
  return `${thermal}; ${light||moisture}.`;
}
function resetBrand(){
  $("brand-title").textContent="Neo Climate Twin";$("brand-summary").innerHTML=`<span id="city-total">${cfg?.city_count?.toLocaleString("es-ES")||"235.471"}</span> urbes · afinidad climática territorial`;
}
function renderDetail(c){selectedDetail=c;$("city-name").textContent=c.city_name;$("city-place").textContent=[c.admin1_name,c.country_name].filter(Boolean).join(" · ");$("population").textContent=c.population?`${Number(c.population).toLocaleString("es-ES")} hab.`:"Población no disponible";$("m-temp").textContent=`${fmt(c.avg_temp_c)} °C`;$("m-range").textContent=`${fmt(c.min_week_temp_c)}–${fmt(c.max_week_temp_c)} °C`;$("m-rain").textContent=`${fmt(c.annual_precip_mm_est,0)} mm/año`;$("m-hum").textContent=`${fmt(c.avg_humidity_pct,0)} %`;$("m-sun").textContent=`${fmt(c.avg_sunshine_hours)} h/d`;$("m-cloud").textContent=`${fmt(c.avg_cloud_pct,0)} %`;$("brand-title").textContent=c.city_name;$("brand-summary").textContent=climateSnapshot(c);}
function clearSelection(){selectedIdx=null;currentScores=null;selectedDetail=null;currentRankingRows=[];rankingSeq++;mapView.clearScores();mapView.setVisibility(new Uint8Array(cfg.city_count).fill(1));mapView.clearSelected();$("selected-view").classList.add("hidden");$("empty-state").classList.remove("hidden");resetBrand();["count-high","count-mid","count-low","compute-ms"].forEach(id=>$(id).textContent="");setStatus("Selección eliminada");}
async function refreshResults(){
  ...
  try{
    ...
    const locale=language==="en"?"en-US":"es-ES",shown=Number(result.shown).toLocaleString(locale),total=Number(result.total).toLocaleString(locale);
    const modeText=language==="en"?(visibility.viewMode==="count"?`the ${shown} cities with the highest affinity`:visibility.viewMode==="percentile"?`the top ${visibility.value}% (${shown} cities)`:`${shown} cities with affinity ≥ ${visibility.value}%`):(visibility.viewMode==="count"?`las ${shown} ciudades con mayor afinidad`:visibility.viewMode==="percentile"?`el ${visibility.value}% superior (${shown} ciudades)`:`${shown} ciudades con afinidad ≥ ${visibility.value}%`);
    $("visibility-note").textContent=language==="en"?(visibility.onlyTop?`The map shows only ${modeText} within ${areaLabel()}.`:`The list compares ${total} cities in ${areaLabel()}; the map retains all eligible cities.`):(visibility.onlyTop?`El mapa muestra únicamente ${modeText} dentro de ${areaLabel()}.`:`La lista compara ${total} ciudades de ${areaLabel()}; el mapa conserva todas las ciudades elegibles.`);
    const box=$("top-list");box.innerHTML="";topReferenceRows=result.rows;
    result.rows.forEach((r,i)=>{const el=document.createElement("button");el.className="top-item";const cls=scoreClass(r.similarity_pct);const factors=(r.factors||[]).map(f=>`${esc(ui(f.label))} ${f.similarity_pct}%`).join(" · ");el.innerHTML=`<span class="rank">${i+1}</span><span class="top-copy"><b>${esc(r.city_name)}</b><small>${esc([r.admin1_name,r.country_name].filter(Boolean).join(" · "))}</small><small class="factor-line">${esc(ui(r.seasonal_alignment||""))} · ${factors}</small></span><span class="score ${cls}">${r.similarity_pct}%</span>`;el.addEventListener("click",()=>selectCity(r.idx,true));box.appendChild(el);});
...
function annualSentence(row,data){
  if(language==="en"){if(row.difference==null)return `${ui(row.label)}: no comparable data.`;const precision=row.id==="rain"?0:1,delta=Math.abs(row.difference),winner=row.difference>0?data.right.city_name:data.left.city_name;if(delta<Math.pow(10,-precision)/2)return `${ui(row.label)}: values are virtually identical.`;const words={temperature:"warmer",rain:"rainier",humidity:"more humid",wind:"windier",cloud:"cloudier",sun:"with more sunshine",solar:"with more solar energy"};return `${winner} is ${words[row.id]||"higher"} by ${studyNumber(delta,precision)} ${ui(row.unit)}.`;}
...
function thermalRange(stats){
  if(!stats||stats.min==null||stats.max==null)return language==="en"?"Thermal range unavailable":"Rango térmico no disponible";
  return language==="en"?`${studyNumber(stats.min)}–${studyNumber(stats.max)} °C · range ${studyNumber(stats.range)} °C`:`${studyNumber(stats.min)}–${studyNumber(stats.max)} °C · oscilación ${studyNumber(stats.range)} °C`;
}
function seasonalSentence(row,data){
  const thermal=row.thermal||{},left=thermal.left||{},right=thermal.right||{};
  if(language==="en"){if(left.mean==null||right.mean==null)return `${ui(SEASON_LABELS[row.id])}: seasonal temperature unavailable.`;const delta=right.mean-left.mean,same=Math.abs(delta)<.25,warmer=delta>0?data.right.city_name:data.left.city_name,temperature=same?"seasonal temperatures are very similar":`${warmer} is ${studyNumber(Math.abs(delta))} °C warmer`,rangeGap=(right.range==null||left.range==null)?"":` · thermal-range difference ${studyNumber(Math.abs(right.range-left.range))} °C`;return `${ui(SEASON_LABELS[row.id])}: ${temperature}; affinity ${row.score}%${rangeGap}.`;}
...
function seasonQuickReading(row,data){
  ...
  if(language==="en"){const temperature=!Number.isFinite(delta)?"seasonal temperature unavailable":Math.abs(delta)<.35?"temperatures are very similar":`${delta>0?data.right.city_name:data.left.city_name} is ${studyNumber(Math.abs(delta))} °C warmer`,domain=contrast?`Main contrast: ${ui(contrast.label).toLowerCase()} (${contrast.similarity_pct}% affinity).`:"No comparable secondary contrast.";return `${temperature}. ${domain}`;}
...
function renderCityStudy(data){
  ...
  const seasons=data.seasons.map(row=>`<div class="season-row"><span>${ui(SEASON_LABELS[row.id])}</span><i><em style="width:${row.score}%"></em></i><b>${row.score}%</b></div>`).join("");
  ...
  const seasonCards=data.seasons.map(row=>{
    ...
    const heading=language==="en"?`${ui(SEASON_LABELS[row.id])} local to ${esc(data.left.city_name)}`:`${SEASON_LABELS[row.id]} local de ${esc(data.left.city_name)}`,scoreLabel=language==="en"?"affinity":"de afinidad";return `<article class="season-card"><header><div><p class="eyebrow">${heading}</p><h3>${row.score}% ${scoreLabel}</h3></div><span class="season-alignment">${esc(ui(row.seasonal_alignment))}</span></header><div class="season-temperature"><div><span>${esc(data.left.city_name)}</span><b>${studyNumber(left.mean)} °C</b><small>${thermalRange(left)}</small></div><div><span>${esc(data.right.city_name)}</span><b>${studyNumber(right.mean)} °C</b><small>${thermalRange(right)}</small></div><strong>${differenceText}<small>B − A</small></strong></div><p class="season-insight">${esc(seasonalSentence(row,data))}</p><div class="season-domains">${weakest}</div></article>`;
  }).join("");
  ...
  const seasonalCaption=$("season-mode").value==="local-season"?`Cada estación se compara con su equivalente local: verano con verano, invierno con invierno, incluso entre hemisferios.`:`Las estaciones se toman de ${esc(data.left.city_name)}. En modo adaptativo, ${esc(data.right.city_name)} se compara con su estación equivalente.`;
  $("city-study-output").innerHTML=`<div class="study-city-head">${panels}<div class="study-score"><b>${data.similarity_pct}%</b><span>afinidad con los parámetros actuales · ${esc(data.seasonal_alignment)}</span></div></div><section class="seasonal-overview"><div><h3>Radiografía estacional</h3><p class="study-caption">${seasonalCaption}</p></div><div class="thermal-summary">${thermalSummary}</div></section><section class="study-reading seasonal-reading"><h3>Lectura por estación</h3><ul>${seasonalReading}</ul></section><section class="season-cards">${seasonCards}</section><div class="study-grid"><section><h3>Afinidad anual por dominio</h3>${domains}</section><section><h3>Resumen de afinidad por estación</h3>${seasons}</section></div><details class="annual-context"><summary>Contexto anual y promedios</summary><section class="annual-table-wrap"><h3>Valores anuales y diferencia</h3><table class="annual-table"><thead><tr><th>Variable</th><th>${esc(data.left.city_name)}</th><th>${esc(data.right.city_name)}</th><th>B − A</th></tr></thead><tbody>${annual}</tbody></table></section><section class="study-reading"><h3>Lectura anual</h3><ul>${reading}</ul></section></details>`;
